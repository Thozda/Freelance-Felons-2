...
{
	static inline consteval int32 GetStructSize() { return sizeof(FWheelData); }
	static inline consteval int16 GetStructAlignment() { return alignof(FWheelData); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Vehicle/FFVehicle.h" },
	};
...
// ********** End ScriptStruct FWheelData constinit property declarations **************************
	static void* NewStructOps()
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FWheelData>();
	}
	static const UECodeGen_Private::FStructParams StructParams;
}; // struct Z_Construct_UScriptStruct_FWheelData_Statics
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FWheelData;
class UScriptStruct* FWheelData::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FWheelData.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FWheelData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWheelData, (UObject*)Z_Construct_UPackage__Script_FreelanceFelonsTwo(), TEXT("WheelData"));
	}
	return Z_Registration_Info_UScriptStruct_FWheelData.OuterSingleton;
	}
...
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FWheelData_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_FreelanceFelonsTwo,
	nullptr,
	&NewStructOps,
	"WheelData",
	Z_Construct_UScriptStruct_FWheelData_Statics::PropPointers,
	UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWheelData_Statics::PropPointers),
	sizeof(FWheelData),
	alignof(FWheelData),
	RF_Public|RF_Transient|RF_MarkAsNative,
	EStructFlags(0x00000005),
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWheelData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FWheelData_Statics::Struct_MetaDataParams)
};
UScriptStruct* Z_Construct_UScriptStruct_FWheelData()
{
	if (!Z_Registration_Info_UScriptStruct_FWheelData.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FWheelData.InnerSingleton, Z_Construct_UScriptStruct_FWheelData_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FWheelData.InnerSingleton);
}
...
// ********** Begin Class AFFVehicle Function CharacterExitPassenger *******************************
struct Z_Construct_UFunction_AFFVehicle_CharacterExitPassenger_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Vehicle/FFVehicle.h" },
...
// ********** Begin Function CharacterExitPassenger constinit property declarations ****************
// ********** End Function CharacterExitPassenger constinit property declarations ******************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AFFVehicle_CharacterExitPassenger_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AFFVehicle, nullptr, "CharacterExitPassenger", 	nullptr, 
	0, 
0,
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AFFVehicle_CharacterExitPassenger_Statics::Function_MetaDataParams), Z_Construct_UFunction_AFFVehicle_CharacterExitPassenger_Statics::Function_MetaDataParams)},  };
UFunction* Z_Construct_UFunction_AFFVehicle_CharacterExitPassenger()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AFFVehicle_CharacterExitPassenger_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AFFVehicle::execCharacterExitPassenger)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->CharacterExitPassenger();
	P_NATIVE_END;
}
// ********** End Class AFFVehicle Function CharacterExitPassenger *********************************

// ********** Begin Class AFFVehicle Function CharacterExitRoof ************************************
struct Z_Construct_UFunction_AFFVehicle_CharacterExitRoof_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Vehicle/FFVehicle.h" },
...
// ********** Begin Function CharacterExitRoof constinit property declarations *********************
// ********** End Function CharacterExitRoof constinit property declarations ***********************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AFFVehicle_CharacterExitRoof_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AFFVehicle, nullptr, "CharacterExitRoof", 	nullptr, 
	0, 
0,
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AFFVehicle_CharacterExitRoof_Statics::Function_MetaDataParams), Z_Construct_UFunction_AFFVehicle_CharacterExitRoof_Statics::Function_MetaDataParams)},  };
UFunction* Z_Construct_UFunction_AFFVehicle_CharacterExitRoof()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AFFVehicle_CharacterExitRoof_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AFFVehicle::execCharacterExitRoof)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->CharacterExitRoof();
	P_NATIVE_END;
}
// ********** End Class AFFVehicle Function CharacterExitRoof **************************************
...
struct Z_Construct_UClass_AFFVehicle_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_WheelSpinMultiplier_MetaData[] = {
		{ "Category", "FFVehicle" },
		{ "ModuleRelativePath", "Public/Vehicle/FFVehicle.h" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_BrakeForceMultiplier_MetaData[] = {
		{ "Category", "FFVehicle" },
		{ "ModuleRelativePath", "Public/Vehicle/FFVehicle.h" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_HandbrakeStoppingForce_MetaData[] = {
		{ "Category", "FFVehicle" },
		{ "ModuleRelativePath", "Public/Vehicle/FFVehicle.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_HandbrakeStoppingForceSpeed_MetaData[] = {
		{ "Category", "FFVehicle" },
		{ "ModuleRelativePath", "Public/Vehicle/FFVehicle.h" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_RestHeight_MetaData[] = {
		{ "Category", "Suspension" },
		{ "ModuleRelativePath", "Public/Vehicle/FFVehicle.h" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_CharacterSocketRoof_MetaData[] = {
		{ "Category", "FFVehicle" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Vehicle/FFVehicle.h" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_FrontLeftWheelTracePoint_MetaData[] = {
		{ "Category", "FFVehicle" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Vehicle/FFVehicle.h" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_FrontRightWheelTracePoint_MetaData[] = {
		{ "Category", "FFVehicle" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Vehicle/FFVehicle.h" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_RearLeftWheelTracePoint_MetaData[] = {
		{ "Category", "FFVehicle" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Vehicle/FFVehicle.h" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_RearRightWheelTracePoint_MetaData[] = {
		{ "Category", "FFVehicle" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Vehicle/FFVehicle.h" },
	};
...
// ********** Begin Class AFFVehicle constinit property declarations *******************************
	...
	static const UECodeGen_Private::FFloatPropertyParams NewProp_WheelSpinMultiplier;
	...
	static const UECodeGen_Private::FFloatPropertyParams NewProp_BrakeForceMultiplier;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_HandbrakeForce;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_HandbrakeStoppingForce;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_HandbrakeStoppingForceSpeed;
	...
	static const UECodeGen_Private::FFloatPropertyParams NewProp_RestHeight;
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_CharacterSocketRoof;
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_FrontLeftWheelTracePoint;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_FrontRightWheel;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_FrontRightWheelTracePoint;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_RearLeftWheel;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_RearLeftWheelTracePoint;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_RearRightWheel;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_RearRightWheelTracePoint;
...
// ********** End Class AFFVehicle constinit property declarations *********************************
	static constexpr UE::CodeGen::FClassNativeFunction Funcs[] = {
		...
		{ .NameUTF8 = UTF8TEXT("CharacterExitPassenger"), .Pointer = &AFFVehicle::execCharacterExitPassenger },
		{ .NameUTF8 = UTF8TEXT("CharacterExitRoof"), .Pointer = &AFFVehicle::execCharacterExitRoof },
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AFFVehicle_CharacterExitPassenger, "CharacterExitPassenger" }, // 567064204
		{ &Z_Construct_UFunction_AFFVehicle_CharacterExitRoof, "CharacterExitRoof" }, // 2918618610
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFFVehicle_Statics::NewProp_MaxReverseSpeed = { "MaxReverseSpeed", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFFVehicle, MaxReverseSpeed), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MaxReverseSpeed_MetaData), NewProp_MaxReverseSpeed_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFFVehicle_Statics::NewProp_WheelSpinMultiplier = { "WheelSpinMultiplier", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFFVehicle, WheelSpinMultiplier), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_WheelSpinMultiplier_MetaData), NewProp_WheelSpinMultiplier_MetaData) };
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFFVehicle_Statics::NewProp_BrakeForceMultiplier = { "BrakeForceMultiplier", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFFVehicle, BrakeForceMultiplier), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BrakeForceMultiplier_MetaData), NewProp_BrakeForceMultiplier_MetaData) };
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFFVehicle_Statics::NewProp_HandbrakeStoppingForce = { "HandbrakeStoppingForce", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFFVehicle, HandbrakeStoppingForce), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_HandbrakeStoppingForce_MetaData), NewProp_HandbrakeStoppingForce_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFFVehicle_Statics::NewProp_HandbrakeStoppingForceSpeed = { "HandbrakeStoppingForceSpeed", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFFVehicle, HandbrakeStoppingForceSpeed), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_HandbrakeStoppingForceSpeed_MetaData), NewProp_HandbrakeStoppingForceSpeed_MetaData) };
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFFVehicle_Statics::NewProp_RestHeight = { "RestHeight", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFFVehicle, RestHeight), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RestHeight_MetaData), NewProp_RestHeight_MetaData) };
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFFVehicle_Statics::NewProp_CharacterSocketRoof = { "CharacterSocketRoof", nullptr, (EPropertyFlags)0x00400000000a0009, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFFVehicle, CharacterSocketRoof), Z_Construct_UClass_USceneComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CharacterSocketRoof_MetaData), NewProp_CharacterSocketRoof_MetaData) };
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFFVehicle_Statics::NewProp_FrontLeftWheelTracePoint = { "FrontLeftWheelTracePoint", nullptr, (EPropertyFlags)0x00400000000a0009, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFFVehicle, FrontLeftWheelTracePoint), Z_Construct_UClass_USceneComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_FrontLeftWheelTracePoint_MetaData), NewProp_FrontLeftWheelTracePoint_MetaData) };
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFFVehicle_Statics::NewProp_FrontRightWheelTracePoint = { "FrontRightWheelTracePoint", nullptr, (EPropertyFlags)0x00400000000a0009, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFFVehicle, FrontRightWheelTracePoint), Z_Construct_UClass_USceneComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_FrontRightWheelTracePoint_MetaData), NewProp_FrontRightWheelTracePoint_MetaData) };
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFFVehicle_Statics::NewProp_RearLeftWheelTracePoint = { "RearLeftWheelTracePoint", nullptr, (EPropertyFlags)0x00400000000a0009, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFFVehicle, RearLeftWheelTracePoint), Z_Construct_UClass_USceneComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RearLeftWheelTracePoint_MetaData), NewProp_RearLeftWheelTracePoint_MetaData) };
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFFVehicle_Statics::NewProp_RearRightWheelTracePoint = { "RearRightWheelTracePoint", nullptr, (EPropertyFlags)0x00400000000a0009, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFFVehicle, RearRightWheelTracePoint), Z_Construct_UClass_USceneComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RearRightWheelTracePoint_MetaData), NewProp_RearRightWheelTracePoint_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AFFVehicle_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFFVehicle_Statics::NewProp_MaxReverseSpeed,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFFVehicle_Statics::NewProp_WheelSpinMultiplier,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFFVehicle_Statics::NewProp_BrakeForceMultiplier,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFFVehicle_Statics::NewProp_HandbrakeForce,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFFVehicle_Statics::NewProp_HandbrakeStoppingForce,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFFVehicle_Statics::NewProp_HandbrakeStoppingForceSpeed,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFFVehicle_Statics::NewProp_RestHeight,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFFVehicle_Statics::NewProp_CharacterSocketRoof,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFFVehicle_Statics::NewProp_FrontLeftWheelTracePoint,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFFVehicle_Statics::NewProp_FrontRightWheel,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFFVehicle_Statics::NewProp_FrontRightWheelTracePoint,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFFVehicle_Statics::NewProp_RearLeftWheel,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFFVehicle_Statics::NewProp_RearLeftWheelTracePoint,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFFVehicle_Statics::NewProp_RearRightWheel,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFFVehicle_Statics::NewProp_RearRightWheelTracePoint,
...
struct Z_CompiledInDeferFile_FID_FreelanceFelonsTwo_Source_FreelanceFelonsTwo_Public_Vehicle_FFVehicle_h__Script_FreelanceFelonsTwo_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AFFVehicle, AFFVehicle::StaticClass, TEXT("AFFVehicle"), &Z_Registration_Info_UClass_AFFVehicle, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AFFVehicle), 3346730748U) },
	};
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FreelanceFelonsTwo_Source_FreelanceFelonsTwo_Public_Vehicle_FFVehicle_h__Script_FreelanceFelonsTwo_3295107880{
